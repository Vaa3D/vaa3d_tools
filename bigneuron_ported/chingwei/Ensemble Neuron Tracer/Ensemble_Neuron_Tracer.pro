...
HEADERS	+= Ensemble_Neuron_Tracer.h
...
SOURCES	+= Ensemble_Neuron_Tracer.cpp
...
TARGET	= $$qtLibraryTarget(Ensemble_Neuron_Tracer)
DESTDIR	= $$VAA3DPATH/bin/plugins/bigneuron_ported/Ensemble_Neuron_Tracer/
