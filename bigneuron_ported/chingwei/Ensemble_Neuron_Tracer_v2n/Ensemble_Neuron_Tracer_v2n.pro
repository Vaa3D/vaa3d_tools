...
HEADERS	+= Ensemble_Neuron_Tracer_v2n.h
...
SOURCES	+= Ensemble_Neuron_Tracer_v2n.cpp
...
TARGET	= $$qtLibraryTarget(Ensemble_Neuron_Tracer_v2n)
DESTDIR	= $$VAA3DPATH/bin/plugins/bigneuron_ported/Ensemble_Neuron_Tracer_v2n/
