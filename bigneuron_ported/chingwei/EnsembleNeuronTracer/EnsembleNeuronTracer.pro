...
HEADERS	+= EnsembleNeuronTracer.h
...
SOURCES	+= EnsembleNeuronTracer.cpp
...
TARGET	= $$qtLibraryTarget(EnsembleNeuronTracer)
DESTDIR	= $$VAA3DPATH/bin/plugins/bigneuron_ported/EnsembleNeuronTracer/
