...
# and a plugin using the the method in [1] in combination with the Minimum Spanning Tree (MST) algorithm to reconstruct a neuron in an image (./RegMST_tracing_plugin)
#
 ...
 *** run the plugin tracing on a small image ***
cd ../../../v3d_external/bin
...
load in vaaa3d the original image : ../../vaa3d_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/cropped_OP_9.tif
               the reconstruction swc file : ../../vaa3d_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/cropped_OP_9.tif_tubularity.v3draw_RegMST_Tracing.swc
