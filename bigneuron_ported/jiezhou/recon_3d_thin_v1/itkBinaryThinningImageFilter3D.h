...
*
* Modified by Jie Zhou to allow processing of images with non-zero background for BigNeuron Hackathon
* voxles with values greater than threshold are set to 1 (foreground). Otherwise are background.
* June 2015
*
