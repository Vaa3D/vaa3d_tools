...
HEADERS	+= NeuronAssembler_NeuTube_plugin.h
SOURCES	+= NeuronAssembler_NeuTube_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_NeuTube)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_NeuTube/
