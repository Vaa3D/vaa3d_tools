/* NeuronAssembler_NeuTube_plugin.h
 * This is a test plugin, you can use it as a demo.
 * 2015-09-29 : by Zhi Zhou
 */
 
#ifndef __NEURONASSEMBLER_NEUTUBE_PLUGIN_H__
#define __NEURONASSEMBLER_NEUTUBE_PLUGIN_H__

#include <QtGui>
#include <v3d_interface.h>

class NeuronAssembler_NeuTube : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
...
class NeuronAssemblerDialog_raw : public QDialog
    ...
    public:
        NeuronAssemblerDialog_raw(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			merge_box = new QSpinBox();
			merge_box->setValue(1);
			layout->addWidget(new QLabel(QObject::tr("merge:")),5,0);
			layout->addWidget(merge_box,5,1,1,5);

			layout->addLayout(hbox2,6,0,3,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(neuTube)"));
            ok->setDefault(true);
			...
			connect(merge_box, SIGNAL(valueChanged(int)), this, SLOT(update()));
...
class NeuronAssemblerDialog : public QDialog
    ...
    public:
        NeuronAssemblerDialog(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			merge_box = new QSpinBox();
			merge_box->setValue(1);
			layout->addWidget(new QLabel(QObject::tr("merge:")),3,0);
			layout->addWidget(merge_box,3,1,1,5);
