...
HEADERS	+= NeuronAssembler_tReMap_plugin.h

SOURCES	+= NeuronAssembler_tReMap_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_tReMap)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_tReMap/
