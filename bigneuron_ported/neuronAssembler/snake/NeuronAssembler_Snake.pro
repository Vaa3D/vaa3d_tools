...
HEADERS	+= NeuronAssembler_Snake_plugin.h

SOURCES	+= NeuronAssembler_Snake_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_Snake)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_Snake/
