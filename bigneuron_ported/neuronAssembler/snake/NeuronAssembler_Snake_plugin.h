/* NeuronAssembler_Snake_plugin.h
 * This is a test plugin, you can use it as a demo.
 * 2015-09-30 : by Zhi Zhou
 */
 
#ifndef __NEURONASSEMBLER_SNAKE_PLUGIN_H__
#define __NEURONASSEMBLER_SNAKE_PLUGIN_H__

#include <QtGui>
#include <v3d_interface.h>

class NeuronAssembler_Snake : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
...
class NeuronAssemblerDialog_raw : public QDialog
    ...
    public:
        NeuronAssemblerDialog_raw(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			layout->addLayout(hbox2,5,0,3,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(snake)"));
            ok->setDefault(true);
...
class NeuronAssemblerDialog : public QDialog
    ...
    public:
        NeuronAssemblerDialog(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			layout->addLayout(hbox2,3,0,2,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(snake)"));
