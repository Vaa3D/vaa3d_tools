...
HEADERS	+= NeuronAssembler_MostVesselTracer_plugin.h

SOURCES	+= NeuronAssembler_MostVesselTracer_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_MostVesselTracer)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_MostVesselTracer/
