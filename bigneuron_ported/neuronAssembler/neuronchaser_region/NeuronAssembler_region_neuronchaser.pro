...
HEADERS	+= NeuronAssembler_region_neuronchaser_plugin.h

SOURCES	+= NeuronAssembler_region_neuronchaser_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_region_neuronchaser)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_region_neuronchaser/
