...
HEADERS	+= NeuronAssembler_neuroGPSTree_plugin.h

SOURCES	+= NeuronAssembler_neuroGPSTree_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_neuroGPSTree)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_neuroGPSTree/
