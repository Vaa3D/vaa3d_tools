...
HEADERS	+= NeuronAssembler_region_advantra_plugin.h

SOURCES	+= NeuronAssembler_region_advantra_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_region_advantra)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_region_advantra/
