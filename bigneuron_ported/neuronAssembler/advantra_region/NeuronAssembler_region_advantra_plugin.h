/* NeuronAssembler_region_advantra_plugin.h
 * This is a test plugin, you can use it as a demo.
 * 2015-01-01 : by Zhi Zhou
 */
 
#ifndef __NEURONASSEMBLER_REGION_ADVANTRA_PLUGIN_H__
#define __NEURONASSEMBLER_REGION_ADVANTRA_PLUGIN_H__

#include <QtGui>
#include <v3d_interface.h>

class NeuronAssembler_region_advantra : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
...
class NeuronAssemblerDialog_raw : public QDialog
    ...
    public:
        NeuronAssemblerDialog_raw(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			region_box->setValue(10000);
			layout->addWidget(new QLabel(QObject::tr("region:")),5,0);
			layout->addWidget(region_box,5,1,1,5);

			scal_box = new QSpinBox();
			scal_box->setValue(10);
			layout->addWidget(new QLabel(QObject::tr("scal:")),6,0);
			layout->addWidget(scal_box,6,1,1,5);

			bratio_box = new QDoubleSpinBox();
			bratio_box->setValue(0.3);
			layout->addWidget(new QLabel(QObject::tr("bratio:")),7,0);
			layout->addWidget(bratio_box,7,1,1,5);

			perc_box = new QSpinBox();
			perc_box->setValue(95);
			...
			layout->addLayout(hbox2,15,0,3,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(Region_advantra)"));
            ok->setDefault(true);
			...
			connect(bratio_box, SIGNAL(valueChanged(double)), this, SLOT(update()));
...
class NeuronAssemblerDialog : public QDialog
    ...
    public:
        NeuronAssemblerDialog(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			th_box = new QSpinBox();
			th_box->setValue(50);
			layout->addWidget(new QLabel(QObject::tr("th:")),2,0);
			layout->addWidget(th_box,2,1,1,5);

			region_box = new QSpinBox();
			region_box->setValue(10000);
			layout->addWidget(new QLabel(QObject::tr("region:")),3,0);
			layout->addWidget(region_box,3,1,1,5);

			scal_box = new QSpinBox();
			scal_box->setValue(10);
			layout->addWidget(new QLabel(QObject::tr("scal:")),4,0);
			layout->addWidget(scal_box,4,1,1,5);

			bratio_box = new QDoubleSpinBox();
			bratio_box->setValue(0.3);
			layout->addWidget(new QLabel(QObject::tr("bratio:")),5,0);
			layout->addWidget(bratio_box,5,1,1,5);
			...
			layout->addLayout(hbox2,13,0,2,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(Region_advantra)"));
