...
HEADERS	+= NeuronAssembler_mST_tracing_plugin.h

SOURCES	+= NeuronAssembler_mST_tracing_plugin.cpp
...
TARGET	= $$qtLibraryTarget(NeuronAssembler_mST_tracing)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/NeuronAssembler_mST_tracing/
