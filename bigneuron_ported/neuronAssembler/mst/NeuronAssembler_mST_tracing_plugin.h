/* NeuronAssembler_mST_tracing_plugin.h
 * This is a test plugin, you can use it as a demo.
 * 2015-10-30 : by Zhi Zhou
 */
 
#ifndef __NEURONASSEMBLER_MST_TRACING_PLUGIN_H__
#define __NEURONASSEMBLER_MST_TRACING_PLUGIN_H__

#include <QtGui>
#include <v3d_interface.h>

class NeuronAssembler_mST_tracing : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
...
class NeuronAssemblerDialog_raw : public QDialog
    ...
    public:
        NeuronAssemblerDialog_raw(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			win_box = new QSpinBox();
			win_box->setValue(5);
			layout->addWidget(new QLabel(QObject::tr("win:")),5,0);
			layout->addWidget(win_box,5,1,1,5);

			layout->addLayout(hbox2,6,0,3,6);
			setWindowTitle(QString("Vaa3D-NeuronAssembler(MST_tracing)"));
            ok->setDefault(true);
			...
			connect(win_box, SIGNAL(valueChanged(int)), this, SLOT(update()));
...
class NeuronAssemblerDialog : public QDialog
    ...
    public:
        NeuronAssemblerDialog(V3DPluginCallback2 &cb, QWidget *parent)
        {
			...
			win_box = new QSpinBox();
			win_box->setValue(5);
			layout->addWidget(new QLabel(QObject::tr("win:")),3,0);
			layout->addWidget(win_box,3,1,1,5);
