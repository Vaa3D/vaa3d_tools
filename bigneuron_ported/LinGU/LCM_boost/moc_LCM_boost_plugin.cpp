/****************************************************************************
** Meta object code from reading C++ file 'LCM_boost_plugin.h'
**
** Created: Sun Jun 21 16:35:44 2015
...
#error "The header file 'LCM_boost_plugin.h' doesn't include <QObject>."
...
void *LoadImageAndSWCPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "V3DPluginInterface2_1"))
        return static_cast< V3DPluginInterface2_1*>(const_cast< LoadImageAndSWCPlugin*>(this));
