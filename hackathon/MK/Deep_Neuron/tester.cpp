...
void Tester::cropStack(unsigned char InputImagePtr[], unsigned char OutputImagePtr[],
...
void Tester::maxIPStack(unsigned char inputVOIPtr[], unsigned char OutputImage2DPtr[],
