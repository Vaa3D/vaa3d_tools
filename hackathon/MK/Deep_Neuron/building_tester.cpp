...
void BuildingTester::cropStack(unsigned char InputImagePtr[], unsigned char OutputImagePtr[],
...
void BuildingTester::maxIPStack(unsigned char inputVOIPtr[], unsigned char OutputImage2DPtr[],
