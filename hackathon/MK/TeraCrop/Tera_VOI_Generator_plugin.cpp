...
using namespace std;
Q_EXPORT_PLUGIN2(Tera_VOI_Generator, TeraCrop);
 
QStringList TeraCrop::menulist() const
{
	return QStringList() 
		<<tr("Crop VOI from image series")
		<<tr("menu2")
		<<tr("about");
}

QStringList TeraCrop::funclist() const
{
	return QStringList()
		<<tr("func1")
		<<tr("func2")
...
void TeraCrop::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
	if (menu_name == tr("Crop VOI from image series"))
	{
	...
	else
	{
		v3d_msg(tr("This is a test plugin, you can use it as a demo.. "
			"Developed by MK, 2017-1-15"));
	}
}

bool TeraCrop::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
