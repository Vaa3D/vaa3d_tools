...
template <class T1, class T2> bool otsu(T1 *data, V3DLONG n, T2 & thres){
	...
	if (1<<(sizeof(T1)*8)>256){
		return false;
	}
	V3DLONG* gralevel=(V3DLONG*)malloc(256*sizeof(V3DLONG));
	memset(gralevel,0,256*sizeof(V3DLONG));

	//统计灰度
	//ofstream outfile;
	//outfile.open("D:/github/Data/gray.txt");
