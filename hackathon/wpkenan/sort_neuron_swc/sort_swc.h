...
//    return result;
//}
//QVector<QString> get_neighbors_string(QList<NeuronSWC> &neurons, const QHash<V3DLONG,V3DLONG> & LUT)
//{
//    // generate neighbor lists for each node, using new ids.
//    // LUT (look-up table): old name -> new ids
//    // ids are the line numbers
...
//    for(V3DLONG i=0; i<neurons.size(); i++){nlist.append(neurons.at(i).n);}
////    if(siz>1000000){
////        v3d_msg("Error: input neuron size exceeded maximum (1000000)");
...
//QList<V3DLONG> DFS_string(QVector<QString> neighbors, V3DLONG newrootid, V3DLONG siz)
//{
