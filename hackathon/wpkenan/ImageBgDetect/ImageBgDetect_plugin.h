...
#define MinGrayValue 0
#define MaxGrayValue 10

class ImageBgDetectPlugin : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
...
public:
	AverageFilterDialog(V3DPluginCallback2 &callback,QWidget *parent)
	{
		...
		windowWidth->setRange(MinGrayValue,MaxGrayValue);
		windowWidth->setValue(MinGrayValue);
