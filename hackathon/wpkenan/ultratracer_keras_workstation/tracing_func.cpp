...
bool crawler_raw_app(V3DPluginCallback2 &callback, QWidget *parent,TRACE_LS_PARA &P,bool bmenu)
{
    ...
    }else
    {
        ...
        }else if (fileOpenName.endsWith(".raw",Qt::CaseSensitive) || fileOpenName.endsWith(".tif",Qt::CaseSensitive))
        {
...
bool app_tracing(V3DPluginCallback2 &callback,TRACE_LS_PARA &P,LandmarkList inputRootList, LocationSimple tileLocation,LandmarkList *newTargetList,QList<LandmarkList> *newTipsList)
{
    ...
    imageSaveString.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y).append(".tif"));
...
bool app_tracing_ada_win_3D(V3DPluginCallback2 &callback,TRACE_LS_PARA &P,LandmarkList inputRootList, LocationSimple tileLocation,LandmarkList *newTargetList,QList<LandmarkList> *newTipsList)
{
    ...
    }else
    {
        ...
        }else if ((QFileInfo(P.inimg_file).completeSuffix() == "raw") || (QFileInfo(P.inimg_file).completeSuffix() == "v3draw")||(QFileInfo(P.inimg_file).completeSuffix() == "tif"))
        {
            V3DLONG *in_zz = 0;
            int datatype;
...
#if defined(Q_OS_LINUX)
        QString cmd_predict = QString("/home/braincenter12/anaconda3/envs/keras3/bin/python /home/braincenter12/PBserver/wpkenan/python/v3d/segmentation/predict.py %1 %2")
                .arg(imageSaveString.toStdString().c_str()).arg(imageUnetString.toStdString().c_str());
        cout << qPrintable(cmd_predict) << endl;
...
bool all_tracing(V3DPluginCallback2 &callback,TRACE_LS_PARA &P,LandmarkList inputRootList, LocationSimple tileLocation,LandmarkList *newTargetList,QList<LandmarkList> *newTipsList)
{
    ...
    imagechecking.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y).append(".tif"));
    if(tileLocation.x >= P.in_sz[0] - 1 || tileLocation.y >= P.in_sz[1] - 1 || end_x <= 0 || end_y <= 0 )
    {
        printf("hit the boundary");
        return true;
    ...
    if(P.method == neutube || P.method == app2)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_neutube.swc");
    else if (P.method == snake)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_snake.swc");
    else if (P.method == most)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_MOST.swc");
    else if (P.method == neurogpstree)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_NeuroGPSTree.swc");
    else if (P.method == advantra)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_region_Advantra.swc");
    else if (P.method == tremap)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_XY_3D_TreMap.swc");
    else if (P.method == mst)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_MST_Tracing.swc");
    else if (P.method == neuronchaser)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_region_NeuronChaser.swc");
    else if (P.method == rivulet2)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif.r2.swc");
...
bool all_tracing_ada_win_3D(V3DPluginCallback2 &callback,TRACE_LS_PARA &P,LandmarkList inputRootList, LocationSimple tileLocation,LandmarkList *newTargetList,QList<LandmarkList> *newTipsList)
{
    ...
    QString swcNEUTUBE = saveDirString;
    if(P.method == neutube || P.method == app2)
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append("_z_").append(QString::number(start_z)).append(".tif_neutube.swc");
    else if (P.method == snake )
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append("_z_").append(QString::number(start_z)).append(".tif_snake.swc");
    else if (P.method == most )
        swcNEUTUBE.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append("_z_").append(QString::number(start_z)).append(".tif_MOST.swc");
...
bool combo_tracing_ada_win(V3DPluginCallback2 &callback,TRACE_LS_PARA &P,LandmarkList inputRootList, LocationSimple tileLocation,LandmarkList *newTargetList,QList<LandmarkList> *newTipsList)
{
    ...
    swcAPP2.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_app2.swc");
    ...
    //    swcMOST.append("/x_").append(QString::number(start_x)).append("_y_").append(QString::number(start_y)).append(".tif_MOST.swc");
...
bool tracing_pair_app(V3DPluginCallback2 &callback, QWidget *parent,TRACE_LS_PARA &P,bool bmenu)
{
    ...
    QString image_name = P.markerfilename+"_gd.tif";
