...
bool Branch::refine_by_2gd(vector<LocationSimple> &outbranch, QString braindir, V3DPluginCallback2 &callback, NeuronTree &nt, double thres)
{
    ...
    for(int i=0; i<seg_count; ++i)
    {
        ...
        CellAPO apo;
        apo.x = segs[i].end_point.x;
        apo.y = segs[i].end_point.y;
        apo.z = segs[i].end_point.z;
        apo.color.r = 0;
        apo.color.g = 255;
        apo.color.b = 0;
        apos.push_back(apo);
    ...
    for(int i=0; i<indexs_of_gd2.size(); ++i)
    {
        ...
        if(i != 0){
            CellAPO apo;
            apo.x = gd1_points[indexs_of_gd2[i]].x;
            apo.y = gd1_points[indexs_of_gd2[i]].y;
            apo.z = gd1_points[indexs_of_gd2[i]].z;
            apo.color.r = 255;
            apo.color.g = 255;
            apo.color.b = 0;
            apos.push_back(apo);
...
//    outbranch.insert(outbranch.end(),gd1_points.begin(),gd1_points.end());
...
//            NeuronSWC p;
    ...
    writeAPO_file(QString("C://Users//admin//Desktop//hl//out.apo"),apos);
