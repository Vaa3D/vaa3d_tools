 ...
 * 2019-4-28 : by YourName
 */
 
#include "v3d_message.h"
#include <vector>
#include "test6_plugin.h"
#include <iostream>
using namespace std;
Q_EXPORT_PLUGIN2(test6, TestPlugin);
...
void TestPlugin::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
	...
	else
	{
		v3d_msg(tr("This is a test plugin, you can use it as a demo.. "
			"Developed by YourName, 2019-4-28"));
	}
}
...
bool TestPlugin::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
  ...
  if (func_name == tr("func1"))
  {
        ...
        cout << ((*pinfiles)[0]) << endl;
        cout << ((*poutfiles)[0]) << endl;
    ...
    //        return -1;
        ...
        simple_saveimage_wrapper(callback,outfile,nm,sz,datatype);
        if(nm)
        {
            delete[] nm;
            nm=NULL;
