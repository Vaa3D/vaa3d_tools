...
#include "test4_plugin.h"
Q_EXPORT_PLUGIN2(test4, TestPlugin);
...
void TestPlugin::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
	...
	else
	{
		v3d_msg(tr("This is a test plugin, you can use it as a demo.. "
			"Developed by YourName, 2019-4-27"));
	}
}
...
bool TestPlugin::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
    ...
    else if (func_name == tr("help"))
    {
		...
		printf("**** Usage of test4 tracing **** \n");
		printf("vaa3d -x test4 -f tracing_func -i <inimg_file> -p <channel> <swc_file> <marker_file> <other parameters>\n");
...
void ml_func(V3DPluginCallback2 &callback, QWidget *parent, input_PARA &PARA, bool bmenu)
{
	...
	QString swc_name = PARA.inimg_file + "_test4.swc";
	nt_output.name = "test4";
	QString marker_name = PARA.inimg_file + "_test4.marker";
