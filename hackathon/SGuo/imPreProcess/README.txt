...
* Description
    ...
    of single-neuron images, including image intensity rescaling, bilateral filter, 
    gray-scale morphology operators (openning, dilation, tophat), and fft-based high-pass filtering.
