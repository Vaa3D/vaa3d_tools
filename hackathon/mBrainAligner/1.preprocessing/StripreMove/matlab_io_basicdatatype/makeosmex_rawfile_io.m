...
mex loadRaw2Stack_c.cpp mg_image_lib.cpp mg_utilities.cpp -L../v3d_main/common_lib/winlib64 -ltiff
mex saveStack2File_c.cpp mg_image_lib.cpp mg_utilities.cpp -L../v3d_main/common_lib/winlib64 -ltiff
