...
../binary/linux_bin/global_registration  -f target/CCF_25_u8_xpad.v3draw -c target/CCF_mask.v3draw -m subject/fMOST_18458_raw.v3draw  -p r+f+n -o result/fMOST/ -d 1

../binary/linux_bin/local_registration  -p config/fMOST_config.txt -s result/fMOST/global.v3draw -m subject/fMOST_segmentation/ -l target/target_landmarks/low_landmarks.marker  -g target/ -o result/fMOST/


# registration LSFM sample target
../binary/linux_bin/global_registration  -f target/CCF_25_u8_xpad.v3draw -c target/CCF_mask.v3draw -m subject/LSFM_raw.v3draw  -p r+f+n -o result/LSFM/ -d 70

../binary/linux_bin/local_registration  -p config/LSFM_config.txt -s result/LSFM/global.v3draw -l target/target_landmarks/low_landmarks.marker  -g target/ -o result/LSFM/
...
../binary/linux_bin/global_registration  -f target/CCF_25_u8_xpad.v3draw -c target/CCF_mask.v3draw -m subject/VISoR_raw.v3draw  -p r+f+n -o result/VISoR/ -d 20

../binary/linux_bin/local_registration  -p config/VISoR_config.txt -s result/VISoR/global.v3draw -l target/target_landmarks/low_landmarks.marker  -g target/ -o result/VISoR/
