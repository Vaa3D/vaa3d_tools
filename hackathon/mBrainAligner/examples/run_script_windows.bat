...
..\dist\win64_bin\global_registration.exe -f target/CCF_25_u8_xpad.v3draw -c target/CCF_mask.v3draw ^
^ -m subject/fMOST_18458_raw.v3draw  -p r+f+n -o result/fMOST/ -d 1
..\dist\win64_bin\local_registration.exe -p config/fMOST_config.txt -s result/fMOST/global.v3draw ^
...
..\dist\win64_bin\local_registration.exe -p config/LSFM_config.txt -s result/LSFM/global.v3draw ^
...
..\dist\win64_bin\local_registration.exe -p config/MRI_config.txt -s result/MRI/global.v3draw ^
...
..\dist\win64_bin\local_registration.exe -p config/VISoR_config.txt -s result/VISoR/global.v3draw ^
