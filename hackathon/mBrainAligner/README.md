...
RAM: 32+ GB
CPU: 2.3GHz dual-10-core Xeon workstation
...
#### Process for building mBrainAligner using qmake
...
example(global_registration):
    ...
    vcvars64.bat
    nmake release
You can find the executable file from the location "(YOUR PATH)/vaa3d_tools/hackathon/mBrainAligner/global_registration/global_registration.exe". 
