...
bool q_imagewarp_tps(const vector<Coord3D_PCM> &vec_ctlpt_tar,const vector<Coord3D_PCM>  &vec_ctlpt_sub,
		const unsigned char *p_img_sub, const long long *sz_img_sub, const long long *sz_img_tps,
		unsigned char *&p_img_tps)
{
	...
	//assign output/warp image size
	long long sz_img_output[4] = { 0 };
	if (sz_img_output[0] == 0)		sz_img_output[0] = sz_img_tps[0];
	if (sz_img_output[1] == 0)		sz_img_output[1] = sz_img_tps[1];
	if (sz_img_output[2] == 0)		sz_img_output[2] = sz_img_tps[2];
	sz_img_output[3] = sz_img_sub[3];
