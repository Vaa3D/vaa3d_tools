...
INCLUDEPATH  += $$QTPATH/include/QtCore
INCLUDEPATH  += $$QTPATH/include/QtGui
INCLUDEPATH  += $$QTPATH/mkspecs/linux-g++-64
...
HEADERS      += $$CODEPATH/edge_detection.h
HEADERS      += $$CODEPATH/q_histogram_matching.h
HEADERS      += $$V3DMAINPATH/basic_c_fun/basic_surf_objs.h
HEADERS      += $$CODEPATH/q_convolve.h
HEADERS      += $$CODEPATH/q_registration_common.h
HEADERS      += $$CODEPATH/q_rigidaffine_registration.h
HEADERS      += $$CODEPATH/q_warp_affine_tps.h
HEADERS      += $$CODEPATH/rpm.h

#Place all the source files needed for the program to run here
#now we start to build sources files

SOURCES      += $$CODEPATH/edge_detection.cpp
SOURCES      += $$CODEPATH/getopt.c
SOURCES      += $$CODEPATH/main_mBrainAligner_global.cpp
SOURCES      += $$CODEPATH/q_histogram_matching.cpp
SOURCES      += $$V3DMAINPATH/basic_c_fun/mg_image_lib.cpp
SOURCES      += $$V3DMAINPATH/basic_c_fun/mg_utilities.cpp
SOURCES      += $$CODEPATH/rpm.cpp
SOURCES      += $$CODEPATH/stackutil.cpp
SOURCES      += $$V3DMAINPATH/basic_c_fun/v3d_message.cpp
SOURCES      += $$V3DMAINPATH//basic_c_fun/basic_surf_objs.cpp
SOURCES      += $$CODEPATH/q_imresize.cpp
SOURCES      += $$CODEPATH/q_registration_common.cpp
SOURCES      += $$CODEPATH/q_warp_affine_tps.cpp
SOURCES      += $$CODEPATH/q_rigidaffine_registration.cpp
SOURCES      += $$CODEPATH/q_convolve.cpp