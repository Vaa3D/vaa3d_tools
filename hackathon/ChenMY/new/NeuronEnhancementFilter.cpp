...
int NeuronEnhancementFilter::MultiScaleFilter3DB(short *apsImage, float *apfFiltedImg, 
                                                int iColNmb, int iRowNmb, int iSliceNmb, 
                                                int *apiSigma, int iSigmaLength,
                                                float fA, float fB, float fC)
{
...
/*
				...
				//if ((Daeig[1]<0) && (Daeig[2]<0) && (Daeig[0]<0))
				//{
				//	apfFiltedImg[l] = 255;
				//}
			}//for k
...
int NeuronEnhancementFilter::CalculateBallness(short *apfVess, short *apfFiltedImg, 					
						int iSliceNmb, int iColNmb, int iRowNmb, float fA, float fB, float fC)
{
	int i;
	int j;
