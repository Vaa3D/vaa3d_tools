...
public slots:
    ...
    void loadScan_MOST(QString latestString, float overlap, int background, int seed_win, int slip_win,LandmarkList inputRootList, LocationSimple tileLocation, QString saveDirString, bool isSoma);
