...
#include "CurvatureAnisotropicDiffusion_called.h"
...
Q_EXPORT_PLUGIN2(CurvatureAnisotropicDiffusion, CurvatureAnisotropicDiffusionPlugin)


QStringList CurvatureAnisotropicDiffusionPlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK CurvatureAnisotropicDiffusion")
           << QObject::tr("about this plugin");
}

QStringList CurvatureAnisotropicDiffusionPlugin::funclist() const
{
    return QStringList()<< QObject::tr("ITK CurvatureAnisotropicDiffusion")
           << QObject::tr("about this plugin");
}
...
bool CurvatureAnisotropicDiffusionPlugin::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output,
...
void CurvatureAnisotropicDiffusionPlugin::domenu(const QString & menu_name, V3DPluginCallback2 & callback, QWidget * parent)
{
    if (menu_name == QObject::tr("about this plugin"))
    {
        QMessageBox::information(parent, "Version info", "ITK CurvatureAnisotropicDiffusion 1.0 (2010-Jun-21): this plugin is developed by Luis Ibanez.");
        return;
    }
