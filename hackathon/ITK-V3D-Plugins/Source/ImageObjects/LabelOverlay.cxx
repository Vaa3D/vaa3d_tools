...
public:
  ...
  MySpecialized( V3DPluginCallback * callback ): Superclass(callback)
  {
	...
	this->m_vectorFilter=VectorFilterType::New();
   this->RegisterInternalFilter(this->m_Filter,0.8);
   this->RegisterInternalFilter(this->m_CastFilter,0.1);
   this->RegisterInternalFilter(this->m_vectorFilter,0.1);
  }
  ...
  {
    this->SetImageSelectionDialogTitle("LabelOverlay");
...
virtual void ComputeOneRegion()
{
    ...
    this->m_vectorFilter->SetInput(this->m_Filter->GetOutput());
    this->m_vectorFilter->Update();
    this->SetOutputImage(this->m_vectorFilter->GetOutput());
...
private:
  ...
  typename VectorFilterType::Pointer m_vectorFilter;
};
