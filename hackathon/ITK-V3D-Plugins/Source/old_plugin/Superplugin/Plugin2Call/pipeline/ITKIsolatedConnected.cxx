...
QStringList ITKIsolatedConnectedPlugin::funclist() const
{
    return QStringList() << QObject::tr("ITK IsolatedConnected")
           << QObject::tr("about this plugin");
}

void ITKIsolatedConnectedPlugin::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
    ...
    void ComputeOneRegion(const V3DPluginArgList & input, V3DPluginArgList & output)
    {
        ...
        else
        {
            ...
            if( dialog.exec() == QDialog::Accepted )
            {
                ...
                progressDialog.show();
                this->RegisterInternalFilter( this->isolatedConnected, 1.0 );
...
bool ITKIsolatedConnectedPlugin::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output,
                                        V3DPluginCallback2 & v3d,  QWidget * parent)
{
    ...
    ITKIsolatedConnectedSpecializaed<unsigned char,float> *runner=new ITKIsolatedConnectedSpecializaed<unsigned char,float>(&v3d);
