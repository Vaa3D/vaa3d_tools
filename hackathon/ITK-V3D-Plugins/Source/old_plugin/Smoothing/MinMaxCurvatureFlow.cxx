...
Q_EXPORT_PLUGIN2(MinMaxCurvatureFlow, MinMaxCurvatureFlowPlugin)


QStringList MinMaxCurvatureFlowPlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK MinMaxCurvatureFlow")
            << QObject::tr("about this plugin");
}

QStringList MinMaxCurvatureFlowPlugin::funclist() const
{
    return QStringList();
}
...
public:
  ...
  void Execute(const QString &menu_name, QWidget *parent)
    {
    V3DITKGenericDialog dialog("MinMaxCurvatureFlow");
...
void MinMaxCurvatureFlowPlugin::dofunc(const QString & func_name,
...
void MinMaxCurvatureFlowPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "ITK MinMaxCurvatureFlow 1.0 (2010-Jun-21): this plugin is developed by Luis Ibanez.");
    return;
    }
