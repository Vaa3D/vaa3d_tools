...
void CurvatureAnisotropicDiffusionPlugin::dofunc(const QString & func_name,
...
void CurvatureAnisotropicDiffusionPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
