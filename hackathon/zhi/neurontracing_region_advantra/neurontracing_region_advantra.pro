...
HEADERS	+= neurontracing_region_advantra_plugin.h
SOURCES	+= neurontracing_region_advantra_plugin.cpp
...
TARGET	= $$qtLibraryTarget(Region_advantra)
DESTDIR	= $$VAA3DPATH/../bin/plugins/neuron_tracing/Region_advantra/
