...
=========================================================================*/
#ifndef _itkLabelGeometryImageFilter_txx
#define _itkLabelGeometryImageFilter_txx
...
::GenerateData() 
{
  ...
  if( this->GetIntensityInput() )
    ...
    ImageRegionConstIteratorWithIndex<TIntensityImage> it (this->GetIntensityInput(),
                                                           this->GetIntensityInput()->GetBufferedRegion());
    typename ImageRegionConstIteratorWithIndex<TIntensityImage>::IndexType index;
  ...
  float pixelSecondOrderCentralMoment = 1.0/12.0;
