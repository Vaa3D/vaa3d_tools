...
Q_EXPORT_PLUGIN2(prunning_swc, prunning_swc);
...
QStringList prunning_swc::menulist() const
{
	return QStringList() 
		<<tr("prunning")
		<<tr("about");
...
QStringList prunning_swc::funclist() const
{
	return QStringList()
		<<tr("help");
}

void prunning_swc::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
	if (menu_name == tr("prunning"))
	{
...
bool prunning_swc::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
