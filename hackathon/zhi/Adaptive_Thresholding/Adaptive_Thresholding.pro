...
#CONFIG	+= x86_64
V3DMAINPATH = /home/zhiz/work/v3d_external/v3d_main
...
HEADERS	+= Adaptive_Thresholding_plugin.h
SOURCES	+= Adaptive_Thresholding_plugin.cpp
...
TARGET	= $$qtLibraryTarget(Adaptive_Thresholding)
DESTDIR	= /home/zhiz/work/v3d_external/bin/plugins/Adaptive_Thresholding/
