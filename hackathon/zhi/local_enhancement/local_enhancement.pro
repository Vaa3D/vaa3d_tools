...
HEADERS	+= local_enhancement_plugin.h
SOURCES	+= local_enhancement_plugin.cpp
...
TARGET	= $$qtLibraryTarget(local_enhancement)
DESTDIR	= ../../../../v3d_external/bin/plugins/local_enhancement/
