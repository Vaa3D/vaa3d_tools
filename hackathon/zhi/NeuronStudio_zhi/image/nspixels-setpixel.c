...
NS_PRIVATE NsProc _ns_pixel_proc_set_pixel;
...
NS_PRIVATE NsClosureValue _ns_pixel_proc_set_pixel_params[ __NUM_PARAMS ] =
	{
...
typedef void ( *_NsPixelProcSetPixelFunc )
	(
	NsPixelType,
	nspointer,
	nssize,
...
void _ns_pixel_proc_set_pixel_all
	(
	...
	slice = NS_OFFSET_POINTER( void, pixels, bytes_per_slice * z );
	row   = NS_OFFSET_POINTER( void, slice, bytes_per_row * y );

	ns_pixel_row_set( pixel, pixel_type, row, x );
	}


NS_PRIVATE _NsPixelProcSetPixelFunc _ns_pixel_proc_set_pixel_func( NsPixelType pixel_type )
	{
	_NsPixelProcSetPixelFunc func = NULL;
	...
	switch( pixel_type )
		...
		case NS_PIXEL_BGRA_U8_U8_U8_U8:
			func = _ns_pixel_proc_set_pixel_all;
			break;
		}
...
NS_PRIVATE NsError _ns_pixel_proc_set_pixel_call
	(
	NsPixelType     pixel_type,
	nspointer       pixels,
	nssize          width,
	...
	{
	_NsPixelProcSetPixelFunc func;

	if( NULL == ( func = _ns_pixel_proc_set_pixel_func( pixel_type ) ) )
...
NS_PRIVATE NsError _ns_pixel_proc_set_pixel_marshal
	(
	NsClosure  *closure,
	NsValue    *params,
	nssize      num_params,
	...
	return _ns_pixel_proc_set_pixel_call(
...
NsProc* ns_pixel_proc_set_pixel( void )
	{
	_ns_pixel_proc_set_pixel.name        = NS_PIXEL_PROC_SET_PIXEL;
	_ns_pixel_proc_set_pixel.invoke_type = NS_PROC_INVOKE_MARSHAL;
	_ns_pixel_proc_set_pixel.params      = _ns_pixel_proc_set_pixel_params;
	_ns_pixel_proc_set_pixel.num_params  = NS_ARRAY_LENGTH( _ns_pixel_proc_set_pixel_params );
	_ns_pixel_proc_set_pixel.marshal     = _ns_pixel_proc_set_pixel_marshal;

	_ns_pixel_proc_set_pixel.ret_value.name = NULL;
	_ns_pixel_proc_set_pixel.ret_value.type = NS_VALUE_VOID;

	return &_ns_pixel_proc_set_pixel;
	}
