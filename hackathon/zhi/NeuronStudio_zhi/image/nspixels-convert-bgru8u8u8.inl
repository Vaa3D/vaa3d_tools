...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_u1( const NsPixelBgrU8U8U8 *src, NsPixelLumU1 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_u8( const NsPixelBgrU8U8U8 *src, NsPixelLumU8 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_u12( const NsPixelBgrU8U8U8 *src, NsPixelLumU12 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_u16( const NsPixelBgrU8U8U8 *src, NsPixelLumU16 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_f32( const NsPixelBgrU8U8U8 *src, NsPixelLumF32 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_lum_alpha_u8_u8( const NsPixelBgrU8U8U8 *src, NsPixelLumAlphaU8U8 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_rgb_u8_u8_u8( const NsPixelBgrU8U8U8 *src, NsPixelRgbU8U8U8 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_rgba_u8_u8_u8_u8( const NsPixelBgrU8U8U8 *src, NsPixelRgbaU8U8U8U8 *dest )
	{
...
NS_PRIVATE void _ns_pixel_bgr_u8_u8_u8_to_bgra_u8_u8_u8_u8( const NsPixelBgrU8U8U8 *src, NsPixelBgraU8U8U8U8 *dest )
	{
	/* Set all the channels. Make alpha channel opaque. */
	dest->blue  = src->blue;
	dest->green = src->green;
