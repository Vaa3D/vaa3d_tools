...
#define _NS_PIXEL_PROC_ORTHO_PROJECT_WITH_INDICES_TEMPLATE( src_type, dest_type, func )\
   nssize           x;\
   nssize           y;\
   nssize           src_z;\
	nssize           dest_z;\
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_max_lum_u8_with_indices
   (
   ...
   {
   _NS_PIXEL_PROC_ORTHO_PROJECT_WITH_INDICES_TEMPLATE(
      NsPixelLumU8,
      NsPixelLumU8,
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_min_lum_u8_with_indices
   (
   NsPixelType           src_pixel_type,
   const NsPixelLumU8   *src_pixels,
   nssize                width,
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_sum_lum_u8_with_indices
   (
   NsPixelType           src_pixel_type,
   const NsPixelLumU8   *src_pixels,
   nssize                width,
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_max_lum_u12_or_u16_with_indices
   (
   NsPixelType           src_pixel_type,
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_min_lum_u12_or_u16_with_indices
   (
   NsPixelType           src_pixel_type,
   const NsPixelLumU16  *src_pixels,
   nssize                width,
...
NS_PRIVATE NsError _ns_pixel_proc_ortho_project_sum_lum_u12_or_u16_with_indices
   (
   NsPixelType           src_pixel_type,
   const NsPixelLumU16  *src_pixels,
   nssize                width,
