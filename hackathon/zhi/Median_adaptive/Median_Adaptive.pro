...
HEADERS	+= Median_Adaptive_plugin.h
SOURCES	+= Median_Adaptive_plugin.cpp
...
TARGET	= $$qtLibraryTarget(adaptive_window)
DESTDIR	= /home/zhiz/work/v3d_external/bin/plugins/median_filter/adaptive_window/
