...
#include <vector>
#include "Median_Adaptive_plugin.h"
#include <QtGui>
#include <iostream>
#include <math.h>
#include <stdlib.h>
...
using namespace std;
Q_EXPORT_PLUGIN2(Median_Adaptive, Median_Adaptive);
...
QStringList Median_Adaptive::menulist() const
{
	return QStringList() 
		<<tr("Median_adp")
		<<tr("about");
...
QStringList Median_Adaptive::funclist() const
{
	return QStringList()
		<<tr("MedianAdpFilter")
		<<tr("help");
...
void Median_Adaptive::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
	if (menu_name == tr("Median_adp"))
	{
	...
	else
	{
		v3d_msg(tr("This is a test plugin, you can use it as a demo.. "
			"Developed by Zhi Zhou, 2013-06-11"));
	}
}

bool Median_Adaptive::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
	...
	if (func_name == tr("MedianAdpFilter"))
	{
	}
...
bool processImage(const V3DPluginArgList & input, V3DPluginArgList & output)
{
	...
	//input
     ...
     switch (datatype)
     {
        //  case 1: Median_filter(data1d, in_sz, c, (unsigned char*&)outimg); break;
      //    case 2: Median_filter((unsigned short int*)data1d, in_sz, c, (unsigned short int*&)outimg); break;
      //    case 4: Median_filter((float *)data1d, in_sz,c, (float*&)outimg); break;
          default:
...
void processImage(V3DPluginCallback2 &callback, QWidget *parent)
{
    ...
    arg.type = "random";std::vector<char*> args1; args1.push_back("/home/zhiz/Desktop/vaa3d/Images/ex_Repo_hb9_eve.tif"); arg.p = (void *) & args1; input<< arg;
    ...
    arg.type = "random";std::vector<char*> args2; args2.push_back("/home/zhiz/Desktop/vaa3d/Images/gsdt_ex_Repo_hb9_eve2.tif"); arg.p = (void *) & args2; output<< arg;
    ...
    switch (pixeltype)
    {
        case V3D_UINT8: Median_filter(data1d, in_sz, c,(unsigned char* &)outimg, gsdtdata1d); break;
        case V3D_UINT16: Median_filter((unsigned short int *)data1d, in_sz, c, (unsigned short int* &)outimg,(unsigned short int *)gsdtdata1d); break;
        case V3D_FLOAT32: Median_filter((float *)data1d, in_sz, c, (float* &)outimg,(float *)gsdtdata1d);break;
