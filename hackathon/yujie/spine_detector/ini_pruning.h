#ifndef INI_PRUNING_H
#define INI_PRUNING_H
...
template<class T> bool init_prune(vector<MyMarker*> &inswc, vector<MyMarker*> & outswc, T * inimg1d, long sz0, long sz1, long sz2, double bkg_thresh = 10.0, double length_thresh = 2.0, double SR_ratio = 1.0/9.0, bool is_leaf_prune = true, bool is_smooth = true)
{
...
#endif
    {
        ...
        memcpy(inimg1d,tmpimg1d, tol_sz * sizeof(T));
