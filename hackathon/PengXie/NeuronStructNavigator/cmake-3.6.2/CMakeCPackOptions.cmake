...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release\\CMakeInstall.bmp")
  ...
  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.6.2")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.6.2, a cross-platform, open-source build system")
...
include("/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright" "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Copyright.txt"
    )
  ...
  set(CPACK_IFW_COMPONENT_GROUP_TOOLS_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CTEST_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CPACK_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CMAKEXBUILD_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_DIALOGS_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Source/QtIFW/CMake.Dialogs.QtGUI.qs")
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_CCMAKE_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-MAN_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/CMake.Documentation.SphinxHTML.qs")
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_VERSION "3.6.2")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-QTHELP_VERSION "3.6.2")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/install_dir.wxs"
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/local1/vaa3d_test/vaa3d_tools/hackathon/MK/NeuronStructNavigator/cmake-3.6.2/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
