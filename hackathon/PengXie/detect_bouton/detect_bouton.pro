...
HEADERS	+= detect_bouton_plugin.h \
    detect_bouton_main.h
SOURCES	+= detect_bouton_plugin.cpp \
    detect_bouton_main.cpp
HEADERS +=  $$VAA3DPATH/v3d_main/basic_c_fun/v3d_interface.h
TARGET	= $$qtLibraryTarget(detect_bouton)
DESTDIR	= $$VAA3DPATH/bin/plugins/detect_bouton/
