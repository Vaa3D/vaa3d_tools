...
bool large_seg_checking(NeuronTree& nt,double dist_thre=30);
bool zero_seg_checking(NeuronTree nt,double dist_thre=0);
bool type_checking(NeuronTree nt,QString & error_type,V3DLONG somaid=-1);
...
QList<NeuronTree> nt_2_trees(NeuronTree nt,bool label=true);
...
NeuronTree internode_remove(NeuronTree nt,bool &processed,float pruning_dist=0.0,bool bouton=false);
