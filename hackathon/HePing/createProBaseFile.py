...
def createBat(solutionName):
    str=":This file can only be used once\n" \
        "@echo off\n" \
        "start \"C:\Program Files (x86)\Microsoft Visual Studio 12.0\Common7\Tools\Shortcuts\VS2013 x64 Native Tools Command Prompt.lnk\"" \
        " qmake -tp vc {}.pro\n" \
...
def createPro(solutionName):
    str="\n"\
        ...
        "DESTDIR = $$V3DMAINPATH/../bin/plugins/hepingPlugin/%s\n"\
        "\n"\
