...
def generator(n_nodes=256, noise_dim=100, batch_size=32):
    ...
    geometry_hidden2 = Dense(4*4*64, activation='relu', name='g_dens_2')(geometry_hidden1)
    geometry_hidden2_reshape = Reshape(target_shape=(4, 4, 64), name='g_dens_reshape')(geometry_hidden2)

    geometry_hidden3 = Deconv2D(32, kernel_size=(5, 5), strides=(2, 2), name='g_deconv_1', padding='same' ,data_format='channels_last',kernel_initializer='normal')(geometry_hidden2_reshape)
    ...
    geometry_hidden4 = Deconv2D(3, kernel_size=(5, 5), strides=(2, 2), name='g_deconv_2', padding='same',data_format='channels_last', kernel_initializer='normal')(geometry_hidden3)
    ...
    morphology_hidden2 = Deconv2D(64,kernel_size=(5, 5), padding='same', strides=(2,2), name='m_deconv_1', data_format='channels_last', kernel_initializer='uniform')(morphology_hidden1)
    ...
    morphology_hidden3 = Deconv2D(32, kernel_size=(5, 5), strides=(2, 2), padding='same', name='m_deconv_2', data_format='channels_last', kernel_initializer='uniform')(morphology_hidden2)
    ...
    morphology_hidden4 = Deconv2D(16, kernel_size=(5, 5), strides=(2, 2), padding='same', name='m_deconv_3', data_format='channels_last', kernel_initializer='uniform')(morphology_hidden3)
    ...
    morphology_hidden5 = Deconv2D(8, kernel_size=(5, 5), strides=(2, 2), padding='same', name='m_deconv_4', data_format='channels_last', kernel_initializer='uniform')(morphology_hidden4)
    ...
    morphology_hidden6 = Deconv2D(1, kernel_size=(5, 5), strides=(2, 2), padding='same', name='m_deconv_5', data_format='channels_last', kernel_initializer='uniform')(morphology_hidden5)
