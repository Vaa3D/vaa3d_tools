...
async function getPictures() {
    ...
    for (index in files) {
        ...
        console.log(rgba);
            ...
            // A begin
        var geometry = new THREE.BoxGeometry(tiff.width(), tiff.height(), count);
       
             /**顶点坐标(纹理映射位置)*/
            geometry.translate(tiff.width()/2 + filestr[1] / 114560 * tiff.width(), tiff.height()/2 + filestr[0] / 136960 * tiff.height(), (filestr[2] / 49280+1 )* count/2);
        ...
        var texture = new THREE.DataTexture3D(rgba, tiff.width(), tiff.height(), count);
       ...
       // console.log(texture);
        ...
        uniforms.u_size.value.set(tiff.width(),tiff.height(), count);
