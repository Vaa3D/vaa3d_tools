...
json_env = 'F:/ZhaoHuImages/AI_denoise/Zhaohu_StitchCode/Z-shift.json'
with open(json_env, 'r')as fp:
    json_data = json.load(fp)
eqs = json_data['result_z_s']
my_symbols = set()
for i in eqs:
    my_symbols.add(i[0])
    my_symbols.add(i[1])
...
with open('F:/ZhaoHuImages/AI_denoise/Zhaohu_StitchCode/Z-shift_g_o_position.json','w') as f:
