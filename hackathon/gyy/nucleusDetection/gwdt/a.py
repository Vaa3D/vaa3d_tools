    ...
    with open(path) as f:
        ...
        for line in lines:
            ...
            if line == '\n':
                ...
                if 20 < point_3D[0] < 200 and 20 < point_3D[1] < 200 and 20 < point_3D[2] < 200:
...
files_path = 'F:/QualityControlProject/Data/results/Zhixi'
files_path2 = 'F:/QualityControlProject/Data/results/Zhixi_'  # 这个文件夹放结果
all_path = 'F:/QualityControlProject/Data/results/all_swc/7888_ZX.swc'  # 合并成1个文件
