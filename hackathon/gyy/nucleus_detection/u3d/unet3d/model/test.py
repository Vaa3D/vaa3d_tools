...
model_path = r'F:\NuMorph\3DNucleiTracingData\cut_Training\relu_center_150_model_35_sphere_001.h5'
...
history = model.fit(raw_ims, ideal_ims,batch_size=1,epochs=20)
