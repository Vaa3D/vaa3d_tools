...
Q_EXPORT_PLUGIN2(Divide, DividePlugin)


QStringList DividePlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK Divide")
            << QObject::tr("about this plugin");
}

QStringList DividePlugin::funclist() const
{
    return QStringList();
}
...
public:
  ...
  void Execute(const QString &menu_name, QWidget *parent)
    {
    this->SetImageSelectionDialogTitle("Divide Input Images");
...
void DividePlugin::dofunc(const QString & func_name,
...
void DividePlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "ITK Divide 1.0 (2010-Jul-31): this plugin is developed by Luis Ibanez.");
    return;
    }
