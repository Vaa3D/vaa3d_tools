...
Q_EXPORT_PLUGIN2(Atan, AtanPlugin)


QStringList AtanPlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK Atan")
            << QObject::tr("about this plugin");
}

QStringList AtanPlugin::funclist() const
{
    return QStringList();
}
...
void AtanPlugin::dofunc(const QString & func_name,
...
void AtanPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
