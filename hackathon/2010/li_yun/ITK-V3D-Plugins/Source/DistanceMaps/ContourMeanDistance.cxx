...
Q_EXPORT_PLUGIN2(ContourMeanDistance, ContourMeanDistancePlugin)


QStringList ContourMeanDistancePlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK ContourMeanDistance")
            << QObject::tr("about this plugin");
}

QStringList ContourMeanDistancePlugin::funclist() const
{
    return QStringList();
}
...
void ContourMeanDistancePlugin::dofunc(const QString & func_name,
...
void ContourMeanDistancePlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "ITK ContourMeanDistance 1.0 (2010-Jun-21): this plugin is developed by Luis Ibanez.");
    return;
    }
