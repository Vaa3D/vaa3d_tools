...
public:
  ...
  virtual void ComputeOneRegion()
   ...
   virtual void SetupParameters()
    ...
    dialog.AddDialogElement("SquaredDistance", 0.0, 0.0, 1.0);
    dialog.AddDialogElement("InputIsBinary", 0.0, 0.0, 1.0); 
    dialog.AddDialogElement("UsePixelSpacing", 1.0, 0.0, 1.0);
    
    if( dialog.exec() == QDialog::Accepted )
      {
      this->m_Filter->SetSquaredDistance( dialog.GetValue("SquaredDistance") );
      this->m_Filter->SetInputIsBinary( dialog.GetValue("InputIsBinary") );
