...
//		SpacingType spacing = rescaler_to_32f_fix->GetOutput()->GetSpacing();

		typedef TransformType::OriginType OriginType;
//		OriginType origin = rescaler_to_32f_fix->GetOutput()->GetOrigin();
