...
Q_EXPORT_PLUGIN2(Modulus, ModulusPlugin)


QStringList ModulusPlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK Modulus")
            << QObject::tr("about this plugin");
}

QStringList ModulusPlugin::funclist() const
{
    return QStringList();
}
...
void ModulusPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "ITK Modulus 1.0 (2010-Jun-21): this plugin is developed by Luis Ibanez.");
    return;
    }
