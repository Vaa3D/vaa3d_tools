...
#ifndef __ITKFASTMARCHINGPLUS_H__
#define __ITKFASTMARCHINGPLUS_H__
...
class ITKFastMarchingPlusPlugin : public QObject, public V3DPluginInterface
{
    Q_OBJECT
...
class ITKFastMarchingPlusDialog : public QDialog
{
  Q_OBJECT

public:
  ITKFastMarchingPlusDialog(V3DPluginCallback &callback, QWidget *parent)
  {
