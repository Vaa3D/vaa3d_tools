...
Q_EXPORT_PLUGIN2(OtsuThreshold, OtsuThresholdPlugin)


QStringList OtsuThresholdPlugin::menulist() const
{
    return QStringList() << QObject::tr("ITK OtsuThreshold")
            << QObject::tr("about this plugin");
}

QStringList OtsuThresholdPlugin::funclist() const
{
    return QStringList();
}
...
void OtsuThresholdPlugin::dofunc(const QString & func_name,
...
void OtsuThresholdPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "ITK OtsuThreshold 1.0 (2010-Jun-21): this plugin is developed by Sophie Chen.");
    return;
    }
