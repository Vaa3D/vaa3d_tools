...
Q_EXPORT_PLUGIN2(DiffeomorphicDemons, ITKDiffeomorphicDemonsPlugin)

QStringList ITKDiffeomorphicDemonsPlugin::menulist() const
{
  return QStringList() << QObject::tr("ITK Diffeomorphic Demons Registration...");
}
...
public:
  ...
  virtual void ComputeOneRegion()
    ...
    std::cout << "Diffeomorphic demons filter started" << std::endl;
    ...
    std::cout << "Diffeomorphic demons filter finished" << std::endl;
...
void ITKDiffeomorphicDemonsPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
  if (menu_name == QObject::tr("about this plugin"))
    {
    QMessageBox::information(parent, "Version info", "Diffeomphophic Demons Registration 1.0 (2010-Jun-3): this plugin is developed by Guorong Wu.");
    return;
    }
