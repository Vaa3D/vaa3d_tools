...
bool export_list2file(QList<NeuronSWC> & lN, QString fileSaveName, QString fileOpenName)
{
    ...
    myfile<<"# generated by Vaa3D Plugin resample_swc\n";
...
bool resample_swc(const V3DPluginArgList & input, V3DPluginArgList & output)
{
    ...
    double step = atof(paralist->at(2));
    qDebug()<<"step is "<<step;
    if(isdatafile==1){
        ...
        nt=((vector<NeuronTree*> *)(input.at(0).p))->at(0);
        //qDebug()<<"is swc !";
    }
    if(isout==1){
        if (output.size()==0)
        ...
        result=((vector<NeuronTree*> *)(output.at(0).p))->at(0);
    }
