...
class UNet(nn.Module):
    def __init__(self, in_channels, filter_num_list, class_num, conv_block=RecombinationBlock, net_mode='3d'):
        ...
        #UNet(1, [16, 32, 48, 64, 96], 3, net_mode='3d', conv_block=RecombinationBlock).to(device)
        if net_mode == '2d':
            conv = nn.Conv2d
        elif net_mode == '3d':
            conv = nn.Conv3d
        ...
        #self.down5 = Down(filter_num_list[3], filter_num_list[4], conv_block=conv_block, net_mode=net_mode)
