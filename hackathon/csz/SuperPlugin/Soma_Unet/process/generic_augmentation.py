...
class ConvertToFloat(object):
    ...
    def __call__(self, img, tree=None, spacing=None):
        ...
        if not tree.dtype.name.startswith('float'):
            tree = tree.astype(self.dtype)
        return img, tree, spacing
...
if __name__ == '__main__':
    import time
    from utils.image_util import normalize_normal, unnormalize_normal
    from utils.util import set_deterministic
