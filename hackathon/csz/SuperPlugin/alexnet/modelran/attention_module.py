...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(16, 16), size2=(8, 8)):
        ...
        self.interpolation1 = nn.Upsample(scale_factor=size2[0], mode='trilinear') # 8*8

        self.up_residual_blocks1 = ResidualBlock(in_channels, out_channels)

        self.interpolation2 = nn.Upsample(scale_factor=size2[0], mode='trilinear')  # 16*16
    ...
    def forward(self, x):
        ...
        # print(self.interpolation2(out_up_residual_blocks1).shape,out_trunk.shape)
...
class AttentionModule_stage2_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size=(8, 8)):
        ...
        self.interpolation1 = nn.Upsample(scale_factor=size[0], mode='trilinear')  # 8*8
