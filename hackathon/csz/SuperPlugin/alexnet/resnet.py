...
class ResNet3DBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        self.bn3 = nn.InstanceNorm3d(out_channels * 4)
    ...
    def _make_layer(self, block, out_channels, blocks, stride=1):
        ...
        if stride != 1 or self.in_channels != out_channels * block.expansion:
            downsample = nn.Sequential(
                ...
                nn.InstanceNorm3d(out_channels * block.expansion),
            )
...
def resnet3d50(num_classes=1000):
    return ResNet3D(ResNet3DBlock, [3, 4, 6, 3], num_classes=num_classes)


def resnet3d101(num_classes=1000):
    return ResNet3D(ResNet3DBlock, [3, 4, 23, 3], num_classes=num_classes)


def resnet3d152(num_classes=1000):
    return ResNet3D(ResNet3DBlock, [3, 8, 36, 3], num_classes=num_classes)
