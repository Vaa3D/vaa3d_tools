...
def swc_to_image(tree, r_exp=3, z_ratio=0.4, imgshape=(256,512,512), flipy=False):
    ...
    selem = np.ones((r_z, r_exp, r_exp), dtype=np.uint8)*10
...
if __name__ == '__main__':
    swc_file = r"E:\csz\gold166\reconstructions_for_gold166_titan_edison_identical_2407\checked6_zebrafish_larve_RGC_UW\hard_hard_10_3dpf_Live_1-28-2010_5-20-37_PM_med_Red.tif_uint8\10_3dpf_Live_1-28-2010_5-20-37_PM_med_Red.tif_uint8.v3dpbd_neutube.swc"
    tree = parse_swc(swc_file)
    lab_img = swc_to_image(tree, 3, 0.4, (155,452,616))
    sitk.WriteImage(sitk.GetImageFromArray(lab_img), r"D:\A_result\swcmask\666.tiff")
