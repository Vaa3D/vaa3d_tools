    ...
    if (func_name == tr("get_block"))
	{
        ...
        for(V3DLONG i = 0; i < swcList.size(); i++)
        {
            ...
            for(int i=0;i<10;i++)
            {
              ...
              double xe=currswc.at(randomnum[i]).x;
              double ye=currswc.at(randomnum[i]).y;
              double ze=currswc.at(randomnum[i]).z;
              double l_x = 128;
              double l_y = 128;
              double l_z = 64;
              ...
              //cout<< "6++++++++++++++++++++++++++++++++"<<endl;
              QString outimg_file;
              QString numofrandom=QString("%1").arg(randomnum.at(i));
