...
struct Input_para
{
    ...
    bool model1;       //1 for.v3dpbd,0 for terafly
    int model2;        //2 for choose piont_xy ,1 for choose point_xyz ,0 for local alignment
    V3DLONG model3;      //0 for 1 class.1 for 2 class,2 for 3 class
};
