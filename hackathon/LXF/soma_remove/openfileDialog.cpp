...
OpenfileDialog::OpenfileDialog(QWidget * parent, V3DPluginCallback2 * _callback)
: QDialog(parent)
{
    callback = _callback;
...
bool OpenfileDialog::setTree(const QString & file)
{
...
void OpenfileDialog::getAllNeuronTreeNames(V3DPluginCallback2 * callback)
{
