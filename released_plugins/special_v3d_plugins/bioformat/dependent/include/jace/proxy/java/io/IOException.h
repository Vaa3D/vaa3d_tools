 ...
 *
 */
IOException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
IOException( jvalue value );
IOException( jobject object );
IOException( const IOException& object );
IOException( const NoOp& noOp );
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::io::IOException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::io::IOException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
