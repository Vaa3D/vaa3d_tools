 ...
 */
Collection();
Collection( jvalue value );
Collection( jobject object );
Collection( const Collection& object );
Collection( const NoOp& noOp );
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::Collection>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::util::Collection>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
