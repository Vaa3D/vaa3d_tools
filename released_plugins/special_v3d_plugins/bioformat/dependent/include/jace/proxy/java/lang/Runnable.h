...
#define JACE_PROXY_JAVA_LANG_RUNNABLE_H
...
/**
 * The Jace C++ proxy class for java.lang.Runnable.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Runnable : public virtual ::jace::proxy::java::lang::Object
{
public: 
 ...
 */
Runnable();
Runnable( jvalue value );
Runnable( jobject object );
Runnable( const Runnable& object );
Runnable( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::Runnable>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::Runnable>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::Runnable>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::Runnable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::Runnable>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::Runnable>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::Runnable>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_RUNNABLE_H
