...
#define JACE_PROXY_JAVA_LANG_CHARSEQUENCE_H
...
/**
 * The Jace C++ proxy class for java.lang.CharSequence.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class CharSequence : public virtual ::jace::proxy::java::lang::Object
{
public: 
 ...
 */
CharSequence();
CharSequence( jvalue value );
CharSequence( jobject object );
CharSequence( const CharSequence& object );
CharSequence( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::CharSequence>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::CharSequence>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::CharSequence>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::CharSequence>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::CharSequence>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::CharSequence>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::CharSequence>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_CHARSEQUENCE_H
