...
#define JACE_PROXY_LOCI_FORMATS_IFORMATREADER_H
...
/**
 * The Jace C++ proxy class for loci.formats.IFormatReader.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class IFormatReader : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::IFormatHandler
{
public: 
 ...
 */
IFormatReader();
IFormatReader( jvalue value );
IFormatReader( jobject object );
IFormatReader( const IFormatReader& object );
IFormatReader( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::IFormatReader>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::IFormatReader>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::IFormatReader>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::IFormatReader>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::IFormatReader( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::IFormatReader>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::IFormatReader>& proxy ) : 
    ::jace::proxy::loci::formats::IFormatReader( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::IFormatReader( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::IFormatReader( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::IFormatReader>& object ) : 
    ::jace::proxy::loci::formats::IFormatReader( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_IFORMATREADER_H
