#ifndef JACE_PROXY_LOCI_FORMATS_IMAGEREADER_H
#define JACE_PROXY_LOCI_FORMATS_IMAGEREADER_H
...
/**
 * The Jace C++ proxy class for loci.formats.ImageReader.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class ImageReader : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::IFormatReader
{
public: 
 ...
 *
 */
ImageReader( ::jace::proxy::loci::formats::ClassList p0 );
 ...
 *
 */
::jace::proxy::loci::formats::IFormatReader getReader( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
::jace::JArray< ::jace::proxy::loci::formats::IFormatReader > getReaders();
 ...
 *
 */
ImageReader( jvalue value );
ImageReader( jobject object );
ImageReader( const ImageReader& object );
ImageReader( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::ImageReader>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::ImageReader>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ImageReader>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ImageReader>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::ImageReader( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ImageReader>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ImageReader>& proxy ) : 
    ::jace::proxy::loci::formats::ImageReader( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ImageReader>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::ImageReader( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::ImageReader( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ImageReader>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ImageReader>& object ) : 
    ::jace::proxy::loci::formats::ImageReader( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_IMAGEREADER_H
