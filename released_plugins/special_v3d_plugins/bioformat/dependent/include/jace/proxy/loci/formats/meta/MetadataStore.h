...
#define JACE_PROXY_LOCI_FORMATS_META_METADATASTORE_H
...
/**
 * The Jace C++ proxy class for loci.formats.meta.MetadataStore.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class MetadataStore : public virtual ::jace::proxy::java::lang::Object
{
public: 
 ...
 */
MetadataStore();
MetadataStore( jvalue value );
MetadataStore( jobject object );
MetadataStore( const MetadataStore& object );
MetadataStore( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::meta::MetadataStore( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::MetadataStore>& proxy ) : 
    ::jace::proxy::loci::formats::meta::MetadataStore( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::meta::MetadataStore( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::meta::MetadataStore( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::MetadataStore>& object ) : 
    ::jace::proxy::loci::formats::meta::MetadataStore( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_META_METADATASTORE_H
