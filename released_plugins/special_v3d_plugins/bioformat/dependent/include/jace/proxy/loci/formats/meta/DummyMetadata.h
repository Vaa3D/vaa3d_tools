#ifndef JACE_PROXY_LOCI_FORMATS_META_DUMMYMETADATA_H
#define JACE_PROXY_LOCI_FORMATS_META_DUMMYMETADATA_H
...
/**
 * The Jace C++ proxy class for loci.formats.meta.DummyMetadata.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class DummyMetadata : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::meta::IMetadata
{
public: 
 ...
 *
 */
DummyMetadata( jvalue value );
DummyMetadata( jobject object );
DummyMetadata( const DummyMetadata& object );
DummyMetadata( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::meta::DummyMetadata( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>& proxy ) : 
    ::jace::proxy::loci::formats::meta::DummyMetadata( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::meta::DummyMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::meta::DummyMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::DummyMetadata>& object ) : 
    ::jace::proxy::loci::formats::meta::DummyMetadata( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_META_DUMMYMETADATA_H
