#ifndef JACE_PROXY_LOCI_FORMATS_META_AGGREGATEMETADATA_H
#define JACE_PROXY_LOCI_FORMATS_META_AGGREGATEMETADATA_H
...
/**
 * The Jace C++ proxy class for loci.formats.meta.AggregateMetadata.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class AggregateMetadata : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::meta::IMetadata
{
public: 
 ...
 *
 */
AggregateMetadata( ::jace::proxy::java::util::List p0 );

/**
 * addDelegate
 *
 */
void addDelegate( ::jace::proxy::loci::formats::meta::MetadataStore p0 );

/**
 * removeDelegate
 *
 */
void removeDelegate( ::jace::proxy::loci::formats::meta::MetadataStore p0 );

/**
 * getDelegates
 *
 */
::jace::proxy::java::util::List getDelegates();
 ...
 *
 */
AggregateMetadata( jvalue value );
AggregateMetadata( jobject object );
AggregateMetadata( const AggregateMetadata& object );
AggregateMetadata( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::meta::AggregateMetadata( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>& proxy ) : 
    ::jace::proxy::loci::formats::meta::AggregateMetadata( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::meta::AggregateMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::meta::AggregateMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::meta::AggregateMetadata>& object ) : 
    ::jace::proxy::loci::formats::meta::AggregateMetadata( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_META_AGGREGATEMETADATA_H
