#ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML200802METADATA_H
#define JACE_PROXY_LOCI_FORMATS_OME_OMEXML200802METADATA_H
...
/**
 * The Jace C++ proxy class for loci.formats.ome.OMEXML200802Metadata.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class OMEXML200802Metadata : public ::jace::proxy::loci::formats::ome::OMEXMLMetadata
{
public: 

/**
 * OMEXML200802Metadata
 *
 */
OMEXML200802Metadata();
 ...
 *
 */
OMEXML200802Metadata( jvalue value );
OMEXML200802Metadata( jobject object );
OMEXML200802Metadata( const OMEXML200802Metadata& object );
OMEXML200802Metadata( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200802Metadata( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>& proxy ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200802Metadata( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200802Metadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200802Metadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200802Metadata>& object ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200802Metadata( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML200802METADATA_H
