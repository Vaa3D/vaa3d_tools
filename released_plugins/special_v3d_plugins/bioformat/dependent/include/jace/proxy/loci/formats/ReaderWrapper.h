...
#define JACE_PROXY_LOCI_FORMATS_READERWRAPPER_H
...
/**
 * The Jace C++ proxy class for loci.formats.ReaderWrapper.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class ReaderWrapper : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::IFormatReader
{
public: 
 ...
 *
 */
ReaderWrapper( ::jace::proxy::loci::formats::IFormatReader p0 );
 ...
 *
 */
::jace::proxy::loci::formats::IFormatReader unwrap();

/**
 * unwrap
 *
 */
::jace::proxy::loci::formats::IFormatReader unwrap( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
ReaderWrapper( jvalue value );
ReaderWrapper( jobject object );
ReaderWrapper( const ReaderWrapper& object );
ReaderWrapper( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::ReaderWrapper( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ReaderWrapper>& proxy ) : 
    ::jace::proxy::loci::formats::ReaderWrapper( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::ReaderWrapper( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::ReaderWrapper( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ReaderWrapper>& object ) : 
    ::jace::proxy::loci::formats::ReaderWrapper( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_READERWRAPPER_H
