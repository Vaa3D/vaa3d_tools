#ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML200706METADATA_H
#define JACE_PROXY_LOCI_FORMATS_OME_OMEXML200706METADATA_H
...
/**
 * The Jace C++ proxy class for loci.formats.ome.OMEXML200706Metadata.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class OMEXML200706Metadata : public ::jace::proxy::loci::formats::ome::OMEXMLMetadata
{
public: 

/**
 * OMEXML200706Metadata
 *
 */
OMEXML200706Metadata();
 ...
 *
 */
OMEXML200706Metadata( jvalue value );
OMEXML200706Metadata( jobject object );
OMEXML200706Metadata( const OMEXML200706Metadata& object );
OMEXML200706Metadata( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200706Metadata( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>& proxy ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200706Metadata( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200706Metadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200706Metadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML200706Metadata>& object ) : 
    ::jace::proxy::loci::formats::ome::OMEXML200706Metadata( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML200706METADATA_H
