#ifndef JACE_PROXY_LOCI_FORMATS_FILESTITCHER_H
#define JACE_PROXY_LOCI_FORMATS_FILESTITCHER_H
...
/**
 * The Jace C++ proxy class for loci.formats.FileStitcher.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class FileStitcher : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::loci::formats::IFormatReader
{
public: 
 ...
 *
 */
FileStitcher( ::jace::proxy::types::JBoolean p0 );

/**
 * FileStitcher
 *
 */
FileStitcher( ::jace::proxy::loci::formats::IFormatReader p0 );

/**
 * FileStitcher
 *
 */
FileStitcher( ::jace::proxy::loci::formats::IFormatReader p0, ::jace::proxy::types::JBoolean p1 );
 ...
 *
 */
::jace::proxy::loci::formats::IFormatReader getReader( ::jace::proxy::types::JInt p0 );

/**
 * getAdjustedIndex
 *
 */
::jace::proxy::types::JInt getAdjustedIndex( ::jace::proxy::types::JInt p0 );
 ...
 *
 */
::jace::proxy::loci::formats::AxisGuesser getAxisGuesser();

/**
 * findPattern
 *
 */
::jace::proxy::loci::formats::FilePattern findPattern( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
FileStitcher( jvalue value );
FileStitcher( jobject object );
FileStitcher( const FileStitcher& object );
FileStitcher( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::FileStitcher>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::FileStitcher>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::FileStitcher>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::FileStitcher>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::FileStitcher( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::FileStitcher>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::FileStitcher>& proxy ) : 
    ::jace::proxy::loci::formats::FileStitcher( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::FileStitcher( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::FileStitcher( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::FileStitcher>& object ) : 
    ::jace::proxy::loci::formats::FileStitcher( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_FILESTITCHER_H
