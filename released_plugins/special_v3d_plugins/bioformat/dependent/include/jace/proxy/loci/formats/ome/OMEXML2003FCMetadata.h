#ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML2003FCMETADATA_H
#define JACE_PROXY_LOCI_FORMATS_OME_OMEXML2003FCMETADATA_H
...
/**
 * The Jace C++ proxy class for loci.formats.ome.OMEXML2003FCMetadata.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class OMEXML2003FCMetadata : public ::jace::proxy::loci::formats::ome::OMEXMLMetadata
{
public: 

/**
 * OMEXML2003FCMetadata
 *
 */
OMEXML2003FCMetadata();
 ...
 *
 */
OMEXML2003FCMetadata( jvalue value );
OMEXML2003FCMetadata( jobject object );
OMEXML2003FCMetadata( const OMEXML2003FCMetadata& object );
OMEXML2003FCMetadata( const NoOp& noOp );
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>& proxy );
#else
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::ElementProxy( jarray array, jvalue element, int index ) : 
    ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata( element ), Object( NO_OP ), mIndex( index )
  {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> inline ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::ElementProxy( const jace::ElementProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>& proxy ) : 
    ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata( proxy.getJavaJniObject() ), Object( NO_OP ), mIndex( proxy.mIndex )
  {
    JNIEnv* env = ::jace::helper::attach();
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>& object );
#else
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata( value ), Object( NO_OP ), fieldID( fieldID_ )
  {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> inline JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata>& object ) : 
    ::jace::proxy::loci::formats::ome::OMEXML2003FCMetadata( object.getJavaJniValue() ), Object( NO_OP )
  {
...
#endif // #ifndef JACE_PROXY_LOCI_FORMATS_OME_OMEXML2003FCMETADATA_H
