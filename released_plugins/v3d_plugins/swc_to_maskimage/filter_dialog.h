...
void ComputemaskImage(NeuronTree neurons,unsigned char* pImMask,V3DLONG sx,V3DLONG sy,V3DLONG sz,QList<int>mark_other_nodes={},bool mark_other_nodes_or_not=0, double margin=0);
