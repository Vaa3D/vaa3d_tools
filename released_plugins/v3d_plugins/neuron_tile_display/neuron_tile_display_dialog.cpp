...
void NeuronTileDisplayDialog::enterEvent(QEnterEvent *e)
{
    checkwindow();
...
void NeuronXYTileDialog::enterEvent(QEnterEvent *e)
{
    checkwindow();
...
void NeuronTileGroupsDialog::enterEvent(QEnterEvent *e)
{
    checkwindow();
