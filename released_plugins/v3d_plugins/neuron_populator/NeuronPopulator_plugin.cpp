...
{
    //To be implemented
    v3d_msg("The domenu() is not implemented. Please use the command line to prune.");
...
{
   //To be implemented
    v3d_msg("The domenu() is not implemented. Please use the command line to detect # of contacts.");
