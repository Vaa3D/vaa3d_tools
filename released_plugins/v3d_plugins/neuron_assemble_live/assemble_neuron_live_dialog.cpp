...
void assemble_neuron_live_dialog::sortsaveSWC()
{
    ...
    NeuronTree nt_sort = SortSWC_pipeline(NeuronList,NONE, 0);     //added one more sorting step by Zhi Zhou
...
bool export_list2file(const QList<NeuronSWC>& lN, QString fileSaveName)
{
    ...
    myfile<<"# generated by Vaa3D Plugin neuron_assembler_live"<<Qt::endl;
    if(eswc_flag)
        myfile<<"##n,type,x,y,z,radius,parent,segment_id,segment_layer,feature_value"<<Qt::endl;
    else
