...
void SWC2MaskPlugin::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
...
bool SWC2MaskPlugin::dofunc(const QString &func_name, const V3DPluginArgList &input, V3DPluginArgList &output, V3DPluginCallback2 &callback, QWidget *parent)
{
