...
template<class T, class TMarker> double markerRadius_hanchuan_XY(T* &inimg1d, V3DLONG * sz, TMarker & marker, double thresh)
{
	long sz0 = sz[0];
	long sz01 = sz[0] * sz[1];
    double max_r = sz[0]/2;
...
template<class T, class TMarker> double markerRadius_hanchuan(T* &inimg1d, V3DLONG * sz, TMarker & marker, double thresh)
{
	long sz0 = sz[0];
	long sz01 = sz[0] * sz[1];
    double max_r = sz[0]/2;
...
//========================== 2D ==========================
template<class T, class TMarker> double markerRadiusXY(T* &inimg1d, V3DLONG * sz, TMarker & marker, double thresh)
{
	return markerRadius_hanchuan_XY(inimg1d, sz, marker, thresh);
}
#endif
