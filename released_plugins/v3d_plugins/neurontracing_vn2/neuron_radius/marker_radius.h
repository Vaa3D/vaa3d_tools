...
template<class T> double markerRadius_hanchuan_XY(T* &inimg1d, V3DLONG * sz, MyMarker & marker, double thresh)
{
...
//========================== 2D ==========================
template<class T> double markerRadiusXY(T* &inimg1d, V3DLONG * sz, MyMarker & marker, double thresh)
{
