...
static size_t    Point_Offset, Point_Inuse;
...
static size_t    Box_Offset, Box_Inuse;
...
static size_t    Frame_Offset, Frame_Inuse;
...
static size_t    Transform_Offset, Transform_Inuse;
