...
int imageTransfromAndCombine::dotransform_swc(V3DPluginCallback2 &callback, QWidget *parent)
{
    //input file name
...
int imageTransfromAndCombine::dotransform_marker(V3DPluginCallback2 &callback, QWidget *parent)
{
    //input file name
    QString fileOpenName;
