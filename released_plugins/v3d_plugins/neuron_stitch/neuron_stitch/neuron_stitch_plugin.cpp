...
bool neuron_stitch::dofunc(const QString & func_name, const V3DPluginArgList & input, V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
	...
	{
        cout<<"==== neuron stack auto stitcher ===="<<"\n";
        ...
        if(paras.size()>0){
            ...
            if(tmp>=0 && tmp<=2)
                ...
                cerr<<"error: wrong stack direction: "<<tmp<<"; use default value 2 (z direction)"<<"\n";
        }
        if(paras.size()>1){
            ...
            if(tmp>1e-10)
                ...
                cerr<<"error: wrong rescale value: "<<tmp<<"; use default value 1"<<"\n";
        }
        if(paras.size()>2){
            ...
            if(tmp>0&&tmp<180)
                ...
                cerr<<"error: wrong angular threshold: "<<tmp<<"; use default value 60"<<"\n";
        }
        if(paras.size()>3){
            ...
            if(tmp>=0)
                ...
                cerr<<"error: wrong point match distance threshold: "<<tmp<<"; use default value 100"<<"\n";
        }
        if(paras.size()>4){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong triangle match distance threshold: "<<tmp<<"; use default value 100"<<"\n";
        }
        if(paras.size()>5){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong max number of triangles: "<<tmp<<"; use default value 10000"<<"\n";
        }
        if(paras.size()>6){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong border tips seraching span: "<<tmp<<"; use default value 20"<<"\n";
        }
        if(paras.size()>7){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong border tips gap filter: "<<tmp<<"; use default value 0, no tips will be filtered by gap"<<"\n";
        }
        if(paras.size()>8){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong border tips segment filter: "<<tmp<<"; use default value 0, no tips will be filtered by segment"<<"\n";
        }
        if(paras.size()>9){
            ...
            if(tmp>0)
                ...
                cerr<<"error: wrong border tips spine size filter: "<<tmp<<"; use default value 0, no tips will be considered as spine"<<"\n";
        }
        if(paras.size()>10){
            ...
            if(tmp>=0 & tmp<=180)
                ...
                cerr<<"error: wrong border tips spine angle filter: "<<tmp<<"; use default value 180, no spine will be filtered by angle"<<"\n";
        }
        if(paras.size()>11){
            ...
            if(tmp>=0)
                ...
                cerr<<"error: wrong border tips spine radius filter: "<<tmp<<"; use default value 0, no tips will be considered as spine"<<"\n";
        }
        if(paras.size()>12){
            ...
            if(tmp==0 || tmp==1)
                ...
                cerr<<"error: wrong type constrain mask: "<<tmp<<"; use default value 0, no constrain will be given"<<"\n";
        }
        ...
        matchfunc.init();
        //global match
        cout<<"start global search"<<"\n";
        matchfunc.globalmatch();
        //stitch
        cout<<"stitch matched points"<<"\n";
        matchfunc.stitch();
...
void neuron_stitch::printHelp()
{
    cout<<"\nUsage: v3d -x neuron_stitch -f neuron_stitch_auto -i <input_first.swc> <input_second.swc> -o <output_base> "
       <<"-p <stack dir=2(x/y/z=0/1/2)> <stack rescale=1> <match angle thr=60> <match distance thr=100> <triangle match thr=100> <max number of triangles=10000> "<<
            ...
            "<border tips spine filter_angle=180> <border tips spine filter_radius=0> <match branch by type=0>"<<"\n";
    cout<<"\n";
}
