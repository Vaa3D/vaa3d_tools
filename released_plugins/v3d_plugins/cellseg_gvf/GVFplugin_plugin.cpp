...
void GVFplugin::domenu(const QString &menu_name, V3DPluginCallback2 &callback, QWidget *parent)
{
    if (menu_name == tr("Gradient vector flow based Segmentation"))
    {
        ...
        segpara.diffusionIteration = QInputDialog::getInt(parent, "Diffusion Iterations",
        ...
        segpara.fusionThreshold = QInputDialog::getInt(parent, "Fusion Threshold",
        ...
        segpara.minRegion= QInputDialog::getInt(parent, "Minimum Region",
