...
bool NeuronPlugin::Tracing_Ray_SWC(const V3DPluginArgList & input, V3DPluginArgList & output)
{
	...
	NeuronTree nt= NeuronTracing_Ray_SWC(inimg1d, sz[0], sz[1], sz[2], first_marker.x, first_marker.y, first_marker.z);
...
NeuronTree NeuronPlugin::NeuronTracing_Ray_SWC(unsigned char *apsInput, V3DLONG sx, V3DLONG sy, V3DLONG sz,V3DLONG mx ,V3DLONG my, V3DLONG mz)
{
