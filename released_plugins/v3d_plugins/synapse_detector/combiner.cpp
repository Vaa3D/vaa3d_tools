...
bool combiner::get_spine_csv_name()
{
    ...
    spine_csv_name_list = QFileDialog::getOpenFileNames(0,0,MySettings.value("combiner_spine_csv").toString(),"Supported file (*.csv)" ";;");
...
{ 
    QSettings MySettings("V3D plugin","combiner");
    is_csv_name_list = QFileDialog::getOpenFileNames(0,0,MySettings.value("combiner_is_csv").toString(),"Supported file (*.csv)" ";;");
...
bool combiner::get_swc_name()
{
    ...
    input_swc_name = QFileDialog::getOpenFileName(0, 0,fileOpenName,"Supported file (*.swc *.eswc)" ";;Neuron structure(*.swc *eswc)");
