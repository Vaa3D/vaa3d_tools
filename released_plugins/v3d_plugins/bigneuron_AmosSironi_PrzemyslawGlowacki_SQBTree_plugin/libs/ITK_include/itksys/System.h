...
#ifdef __VMS
#define itksysSystem_Shell_GetArgumentForUnix \
   itksysSystem_Shell_UnixGA
#define itksysSystem_Shell_GetArgumentSizeForUnix \
   itksysSystem_Shell_UnixGAS
#define itksysSystem_Shell_GetArgumentForWindows \
   itksysSystem_Shell_WindowsGA
#endif
